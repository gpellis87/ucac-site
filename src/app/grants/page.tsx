          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            {grant.applyUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 border border-navy/50 px-7 py-3 text-[0.75rem] uppercase tracking-[0.18em] text-parchment transition hover:border-navy hover:bg-navy/10"
              >
      ...
      <div className="section-pad py-12">
        <div className="mx-auto max-w-[1500px]">
          ...
          <p className="mt-10 max-w-2xl text-sm leading-relaxed text-parchment/55">
            ...
            <Link href="/support#donate" className="text-navy hover:underline">
              Support page
            </Link>
            .
          </p>
