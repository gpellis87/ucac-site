      ...
      <div className="section-pad py-14">
        <div className="mx-auto max-w-[1500px]">
          <div className="grid gap-12 lg:grid-cols-[1fr_360px]">
            ...
            {/* Benefits */}
            <div>
              <p className="text-[0.68rem] uppercase tracking-[0.22em] text-parchment/50 mb-6">Member Benefits</p>
              <ul className="space-y-4">
                {benefits.map((benefit) => (
                  <li key={benefit} className="flex items-start gap-4">
                    ...
                    <span className="text-sm text-parchment/80 leading-relaxed">{benefit}</span>
                  </li>
                ))}
              </ul>

              <div className="mt-10 border-t border-parchment/10 pt-8">
                <p className="text-sm text-parchment/55 leading-relaxed max-w-xl">
                ...
                <p className="mt-4 text-sm text-parchment/55 leading-relaxed max-w-xl">
            ...
            <div className="space-y-5">
              ...
              <div className="border border-parchment/15 bg-black/30 p-7">
                <p className="text-[0.68rem] uppercase tracking-[0.22em] text-parchment/50 mb-3">Coming to Our New Space</p>
