...
import { buildGoogleCalendarLink, eventCategoryStyle, formatEventDate } from "@/lib/event-utils";
        ...
        <div className="section-pad absolute inset-x-0 bottom-0 pb-10">
          <div className="mx-auto max-w-[1500px]">
            <div className="mb-4 flex flex-wrap gap-2 text-xs uppercase tracking-[0.14em]">
              <span className={`px-3 py-1 font-semibold ${eventCategoryStyle[event.category]}`}>{event.category}</span>
