...
export const artists: Artist[] = [
  ...
  },
  {
    ...
    city: "Matthews",
    state: "NC",
    email: "Tamarapaylor@gmail.com",
    website: "https://madebytmp.my.canva.site",
    medium: "Acrylic & Mixed Media",
    bio: "Tamara Paylor is a Charlotte-based visual artist whose mixed media work explores Black womanhood, emotional depth, and spiritual resilience. Through layered portraits and symbolic compositions, she creates visual affirmations that invite reflection, healing, and self-recognition.",
    portraitUrl: "/artists/tamara-paylor-portrait.jpg",
    workImages: ["/artists/tamara-paylor-work.jpg"],
  },
  {
    id: 5,
    slug: "cindy-grano",
